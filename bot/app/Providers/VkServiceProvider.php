...
class VkServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->singleton(VkProfanityService::class, static function (Application $app) {
            return new VkProfanityService($app->make(VKApiClient::class), config('botman.vk.token'));
        });
    }
}